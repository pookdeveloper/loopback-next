...
example of a controller method which retrieves a Note model instance by
obtaining the `id` from the query string object.
...
[Interceptor docs](https://github.com/strongloop/loopback-next/blob/d1646d085bbd5ac8df0d289fb3b8d5b5f5370386/docs/site/Interceptors.md#use-invokemethod-to-apply-interceptors)
for more details. The request flow for two route flavours is explained below.
